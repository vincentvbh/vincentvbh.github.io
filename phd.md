...
- Title: Software Implementations of Polynomial Multiplications for Lattice-Based Cryptosystems.

- Where:
    - [Max Planck Institute for Security and Privacy (MPI-SP), Bochum, Germany](https://www.mpi-sp.org/) (employed as a PhD student).
    - [Radboud University, Nijmegen, the Netherlands](https://www.ru.nl/en) (external PhD student).
- When:
    - 2026-04-28 (defense).
...
- Assets:
    - [Dissertation](https://vincentvbh.github.io/phd_dissertation_printed.pdf)
